...
## 🛠️ Tecnologias
- **Python 3**
- **Pandas** (Engine principal de dados)
- **Matplotlib** (Visualização de dados)
- **Openpyxl** (Integração com Excel)

## 📊 Insights Gerados

Faturamento total por vendedor (Os que mais venderam)


### 📈 Análise de Performance
O pipeline processa o faturamento total e o distribui por cargos (Sênior, Pleno, Júnior), permitindo uma visão clara da eficiência da força de vendas.
